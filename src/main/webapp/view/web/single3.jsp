		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="<c:url value='/template/web/images/tainghe1.jpg'/>">
							<div class="thumb-image"> <img src="<c:url value='/template/web/images/tainghe1.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/tainghe2.jpg'/>">
							 <div class="thumb-image"> <img src="<c:url value='/template/web/images/tainghe2.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/tainghe3.jpg'/>">
						   <div class="thumb-image"> <img src="<c:url value='/template/web/images/tainghe3.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>Tai nghe Bluetooth Apple AirPods Pro </h3>
				<div class="rating1">
				...
				<div class="simpleCart_shelfItem">
					<p><span>6.250.000</span> <i class="item_price">6.150.000</i></p>
					<form action="#" method="post">
						<input type="hidden" name="cmd" value="_cart">
						<input type="hidden" name="add" value="1"> 
						<input type="hidden" name="w3ls_item" value="Audio-speaker"> 
						<input type="hidden" name="amount" value="6150000">   
						...
						<div class="additional_info_sub_grids">
							...
							<div class="col-xs-10 additional_info_sub_grid_right">
								<div class="additional_info_sub_grid_rightl">
									<a href="<c:url value='/view/web/trang-chu.jsp'/>">NguyenHieu</a>
									<h5>10/01/2020</h5>
