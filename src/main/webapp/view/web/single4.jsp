		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="<c:url value='/template/web/images/ip1.jpg'/>">
							<div class="thumb-image"> <img src="<c:url value='/template/web/images/ip1.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/ip2.jpg'/>">
							 <div class="thumb-image"> <img src="<c:url value='/template/web/images/ip2.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/ip3.jpg'/>">
						   <div class="thumb-image"> <img src="<c:url value='/template/web/images/ip3.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
			...
			<div class="col-md-8 single-right">
				<h3>iPhone 11 Pro Chính hãng VN/A </h3>
				<div class="rating1">
				...
				<div class="description">
					<h5><i>iPhone 11 Pro Chính hãng VN/A /i></h5>
				...
				<div class="simpleCart_shelfItem">
					...
					<form action="#" method="post">
						...
						<input type="hidden" name="amount" value="26300000">   
