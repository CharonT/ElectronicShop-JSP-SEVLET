		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
					<li data-thumb="<c:url value='/template/web/images/loa1.jpg'/>">
							<div class="thumb-image"> <img src="<c:url value='/template/web/images/loa1.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/loa2.jpg'/>">
							<div class="thumb-image"> <img src="<c:url value='/template/web/images/loa2.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/loa3.jpg'/>">
							 <div class="thumb-image"> <img src="<c:url value='/template/web/images/loa3.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="<c:url value='/template/web/images/loa4.jpg'/>">
							 <div class="thumb-image"> <img src="<c:url value='/template/web/images/loa4.jpg'/>" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
			...
			<div class="col-md-8 single-right">
				...
				<div class="description">
					<h5><i>Loa Marshall Stanmore 2</i></h5>
					<p>Tích hợp công nghệ nâng cao DPS và khả năng kết nối tiện lợi bluetooth v5.0/AUX/RCA
Các sản phẩm âm thanh của thương hiệu Marshall luôn mang lại cho người dùng cảm giác sang trọng và chất lượng âm thanh không cần phải bàn cãi. Nếu đang tìm kiếm cho mình một sản phẩm loa âm thanh mà chất lượng đạt AAA thì sản phẩm loa bluetooth Marshall Stanmore 2 sẽ làm bạn hài lòng.</p>
				</div>
